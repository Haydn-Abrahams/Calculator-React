...
const INT_FORMAT = new Intl.NumberFormat("en-uk", {
...
function App() {
  ...
  return (
    <div className="calculator-grid">
      ...
      <button onClick ={() => dispatch({type: ACTIONS.DELEETE_DIGIT})}>DEL</button>
